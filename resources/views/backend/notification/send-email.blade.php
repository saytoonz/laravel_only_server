        ...
        <div class="animated fadeIn">
            ...
            <div class="row">
                ...
                <div class="col-xs-6 col-sm-6">
                    ...
                    <form action="{{url('send-mail-user')}}" method="POST">
                    {{ csrf_field() }}
                    <input type="hidden" name="tbl" value="{{ encrypt('user_mail') }}">
                ...
                <div class="col-xs-6 col-sm-6">
                    ...
                    <form action="{{url('country-mail-user')}}" method="POST">
                    {{ csrf_field() }}
                        <input type="hidden" name="tbl" value="{{ encrypt('country_mail') }}">
